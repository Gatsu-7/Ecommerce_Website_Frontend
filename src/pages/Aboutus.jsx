...
const AboutUs = () => {
  return (
    <div className=" mx-auto px-10 py-10 bg-gradient-to-tl from-[#13547a] via-[#0c3c58] to-[#020111]">
      <section className="text-center mb-12 ">
        ...
        <p className="text-xl text-gray-100 leading-relaxed">
          ...
          mission is to provide innovative, high-quality massagers and wellness
          products that promote relaxation, relief, and rejuvenation. We believe
          in making self-care accessible and effective for everyone, so you can
          enjoy the comfort and convenience of spa-like treatments right at
          home.
        </p>
      </section>
      ...
      <section className="mb-12">
        ...
        <p className="text-lg text-gray-100 leading-relaxed">
          ...
          has grown into a trusted name in the wellness industry, with thousands
          of customers finding relief and relaxation through our products. Our
          team is committed to researching the latest innovations and crafting
          items that cater to the needs of modern consumers.
        </p>
      </section>
      ...
      <section className="mb-12">
        ...
        <ul className="list-disc ml-6 text-lg text-gray-100 leading-relaxed">
          <li>
            ...
            products that are built to last, designed with the latest technology
      ...
      <section className="mb-12">
        ...
        <p className="text-lg text-gray-100 leading-relaxed">
          When you choose deZon, you're choosing a company that genuinely cares
          about your well-being. Whether you're looking for a deep tissue
          massage after a long day or a soothing neck massage while traveling,
          we have a solution for you. Our products are easy to use, effective,
      ...
      <section className="mb-12">
        ...
        <p className="text-lg text-gray-100 leading-relaxed">
          ...
          range of products designed to fit into your lifestyle. Each product is
          tested for quality and comfort, ensuring you get the best results
          every time. Whether you're dealing with muscle tension, soreness, or
          simply need to relax, we have the perfect product to help you unwind.
        </p>
      </section>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-6">
          ...
          <blockquote className="p-4 bg-gray-100 rounded">
            <p className="text-lg text-black italic">
              “I was hesitant at first, but after using their massage chair for
              a month, I feel like a new person. My back pain is gone, and I
      ...
      <section className="mb-12">
        ...
        <p className="text-lg text-gray-100 leading-relaxed">
          ...
          purchase. Your wellness is our top priority, and we aim to make every
          interaction with us a positive one.
        </p>
      </section>
